	...
	private void initialize() {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { 
				...
				controller.searchTask(porjecttitle).addTask(tmp);
			}
			
		});
		btnAdd.setBounds(142, 185, 117, 29);
